 ...
 */
export async function generateEcgReportPdf(
...
function generateReportHtml(report: EcgStructuredReport): string {
  ...
  try {
    ...
    console.warn("Logo not found, continuing without logo:", error);
  }
...
<body>
  <div class="header">
    ...
    <div class="header-content">
      ...
      <div class="subtitle">Clinical-Grade ECG Analysis</div>
    </div>
  </div>
  ...
  <div class="section">
    ...
    <div class="technical-grid">
      ...
      <div class="technical-group">
        ...
        <div class="technical-item">
          <span class="technical-label">ECG Date:</span>
